...
<!-- Outer Row -->
            ...
            <h3 class="text-center text-success">Registro datos personales de empleados</h3>
          ...
          <div class="col-lg-6">
            <div class="p-5">
              ...
              <form class="user" id="formLogin" method="POST">
                ...
                <button type="button" onclick="loginUser()" id="" class="btn btn-primary btn-user btn-block "><svg class="bi bi-person-check-fill" width="2em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
